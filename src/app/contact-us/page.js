...
const ContactUs = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen lg:h-[1080px] bg-[url('/images/contactbg.png')] bg-no-repeat bg-center bg-cover gap-8">
