...
const OurServices = () => {
  return (
    <div className="w-full mb-24">
      <div className="w-full bg-[url('/images/our-services-hero.jpg')] bg-cover aspect-video flex flex-col items-center justify-center max-h-[1080px] gap-4 lg:gap-6">
      ...
      <div className="w-11/12 mx-auto lg:w-3/4 xl:max-w-screen-2xl">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-4 my-4 mx-auto md:w-4/5 lg:grid-cols-3 xl:w-3/4 2xl:gap-x-20">
            <Snippets
              imageUrl="/icons/Product.svg"
              heading="Product"
              desc="Brief, persuasive messages designed to promote brands, production or services through impactful storytelling and engaging visuals."
            />
            <Snippets
              imageUrl="/icons/Portrait.svg"
              heading="Portrait"
              desc="Brief, persuasive messages designed to promote brands, production or services through impactful storytelling and engaging visuals."
            />
            <Snippets
