const Modal = ({isActive, onClose}) => {
    ...
    <div className="w-screen h-screen fixed top-0 left-0 z-10 bg-[rgba(0,0,0,.5)] text-white flex justify-center items-center" >
        ...
        <iframe className="w-11/12 aspect-video max-w-screen-2xl xl:w-3/4" src="//www.youtube.com/embed/D0UnqGm_miA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share;" allowFullScreen></iframe>
    </div> );
}
